...
7. Return ONLY a valid JSON array of objects with the exact keys: "question", "options" (array of 4 strings), "answer" (integer 0-3), "explanation", and "page". Do not include any conversational text, and do not use markdown code blocks like \`\`\`json.
${existingQuestionsStr}
