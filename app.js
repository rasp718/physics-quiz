...
if (localStorage.getItem('theme') === 'light') {
    ...
    document.getElementById('moon-icon').innerHTML = '<path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>';
    isLightMode = true;
}
...
themeToggle.addEventListener('click', () => {
    ...
    if (isLightMode) {
        ...
        document.getElementById('moon-icon').innerHTML = '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>';
...
${extractedText}
        ...
        document.getElementById('generate-desc').innerText = "Extract 10 new questions using AI";
    }
});
...
function showQuestion() {
    ...
    q.options.forEach((option, index) => {
        ...
        btn.className = 'option-btn deal-anim';
