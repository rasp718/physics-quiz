...
async function fetchAIExplanation(q) {
    ...
    try {
        ...
        if (data.choices && data.choices.length > 0) {
            ...
            aiExplanationBox.innerText = "Error: Please check your API key or try again later.";
        }
    } catch (err) {
        aiExplanationBox.innerText = "Connection error. Make sure you are connected to the internet and your API key is valid.";
    }
