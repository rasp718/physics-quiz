...
function triggerHaptic(type) {
    ...
    try {
        if (type === 'correct') {
            // Light, snappy double-tap
            navigator.vibrate([20, 30, 20]); 
        } else if (type === 'wrong') {
            // Heavy, staggered triple buzz
...
if (localStorage.getItem('theme') === 'light') {
    ...
    document.querySelector('meta[name="theme-color"]').setAttribute('content', '#EBE3D5');
...
// Ensure the orientation change listener also scales the canvas properly
